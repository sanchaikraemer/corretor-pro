...
const STATIC_CACHE = 'corretor-pro-static-v701-' + BUILD_ID;
...
const CORE_ASSETS = [
  '/', '/index.html', '/styles.css?v=701', '/app.js?v=701', '/vendor/jszip.min.js?v=701',
  '/share.html', '/manifest.json', '/service-worker.js', '/icon-192.png?v=701', '/logo-cp.png?v=701',
  '/icon-512.png?v=701', '/favicon.png?v=701', '/logo-direciona-light.svg?v=701', '/logo-direciona-dark.svg?v=701'
];
