...
const STATIC_CACHE = 'corretor-pro-static-v707-' + BUILD_ID;
...
const CORE_ASSETS = [
  '/', '/index.html', '/styles.css?v=707', '/app.js?v=707', '/vendor/jszip.min.js?v=707',
  '/share.html', '/manifest.json', '/service-worker.js', '/icon-192.png?v=707', '/logo-cp.png?v=707',
  '/icon-512.png?v=707', '/favicon.png?v=707', '/logo-direciona-light.svg?v=707', '/logo-direciona-dark.svg?v=707'
];
