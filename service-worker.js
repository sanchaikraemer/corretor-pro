...
const STATIC_CACHE = 'corretor-pro-static-v702-' + BUILD_ID;
...
const CORE_ASSETS = [
  '/', '/index.html', '/styles.css?v=702', '/app.js?v=702', '/vendor/jszip.min.js?v=702',
  '/share.html', '/manifest.json', '/service-worker.js', '/icon-192.png?v=702', '/logo-cp.png?v=702',
  '/icon-512.png?v=702', '/favicon.png?v=702', '/logo-direciona-light.svg?v=702', '/logo-direciona-dark.svg?v=702'
];
