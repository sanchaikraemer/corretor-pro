# NOTAS v1033 — a Home só se atualizava sozinha uma vez (na primeira vez que abria)
...
Essa correção foi feita em paralelo a outra sessão, que também publicou uma correção (do ditado
por voz duplicando texto) e já tinha usado o número 1032 antes desta terminar. Por isso esta
ficou com o número 1033 — sem relação de causa/efeito entre as duas, só ordem de chegada.

## Testes novos

`tests/v1033-home-nunca-atualiza-sozinha.test.mjs` — confirma que a sincronização automática
