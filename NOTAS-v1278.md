# v1278 — quando o cliente já disse o que quer, quem faz a busca é o corretor
...
- Suíte completa verde: 23 arquivos checados + 433 testes, incluindo os novos.
...
- `api/_pipeline.js` — a definição do ângulo "maisSuave", as três regras novas e o item 12 da
  conferência final.
- `tests/v1278-cliente-ja-disse-o-que-quer.test.mjs` — teste novo (o print vira caso de teste).
...
- `package.json` / `package-lock.json` — versão 1278.
