...
export const CATALOGO_ENV = [
  ...
  // v1330 — a análise passou a ter duas etapas (ler, depois escrever as três mensagens).
  { nome: "DIRECIONA_ANALISE_ETAPAS", tipo: "texto", obrigatoria: false, grupo: "Ajuste fino",
    oQueFaz: "1 volta a análise para o pedido único (ler e escrever na mesma tacada). Qualquer outro valor, ou vazio, mantém as duas etapas." },
