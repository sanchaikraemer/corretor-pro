...
Responda somente com JSON válido no formato solicitado.`;
  ...
  //
  // Se algum dia isso precisar voltar ao pedido único, DIRECIONA_ANALISE_ETAPAS=1 na hospedagem
  // reconstrói exatamente o prompt anterior, sem publicar código.
  const duasEtapas = String(process.env.DIRECIONA_ANALISE_ETAPAS || "2").trim() !== "1";
