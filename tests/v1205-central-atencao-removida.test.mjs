...
// v1232 — o sino mudou de desenho: agora vive no bloco da agenda do topo, com o número inline
// (#cpAgHojeN) e classes próprias (cp-hoje-atraso deixa a metade de hoje vermelha). A exigência
