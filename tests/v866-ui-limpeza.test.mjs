...
// v1249 — o card virou "Enviar conversa": ordem do dono, repetida várias vezes — no produto dele
// a conversa é EXPORTADA no WhatsApp e ENVIADA/COMPARTILHADA com o app, nunca "importada".
// O vocabulário da tela é trancado em tests/v1249-a-conversa-e-enviada-nunca-importada.test.mjs.
for(const titulo of ['Enviar conversa', 'O que a IA aprendeu', 'Instalar app']){
