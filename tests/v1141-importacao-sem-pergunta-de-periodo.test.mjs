...
// v1198 — o campo "Período padrão dos áudios" saiu também do Cérebro (decisão do dono): virou
// proteção fixa interna. Este bloco guardava o campo; agora guarda a ausência dele — os detalhes
// do comportamento interno estão em v1198-periodo-audios-sem-campo-na-tela.
