...
// 2. Front: botão "Desmarcar" só aparece quando o lead está atendido hoje.
assert.match(app, /\$\{attended\?`<button type="button" class="cp704-reanalyse" onclick="ui667DesmarcarAtendido\(this\)"/,
