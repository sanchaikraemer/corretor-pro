// A CONVERSA FIXA DO APP — caso de teste permanente, escolhido pelo dono em 20/08/2026.
//
// Sete meses de atendimento real (19/01/2026 a 19/08/2026), guardados aqui num lugar só para que
// mais de um teste possa se apoiar neles sem copiar 64 linhas de conversa em cada arquivo.
// Não é um arquivo ".test.mjs": o executor (tests/run-all.mjs) não roda este arquivo sozinho,
// ele só é importado por quem precisa.
//
// Por que ESTA conversa: ela junta, num arquivo só, quase tudo o que já quebrou neste projeto —
// sete meses de histórico com um sumiço de quatro meses no meio; foto, vídeo, PDF e áudio dos dois
// lados; mensagem de várias linhas numa bolha só; preço antigo convivendo com preço novo; uma
// permuta oferecida pela cliente que muda a faixa de compra dela; e um fim de conversa com várias
// mensagens do corretor sem nenhuma resposta.
//
// NÃO EDITE o texto abaixo para fazer um teste passar. Ele é a fotografia de um atendimento real:
// se um teste deixou de bater com ele, quem mudou foi o app.

export const CONVERSA = `[19/01/2026 15:41] Noemi Barcarol Evoluti: Olá! Tenho interesse e queria mais informações, por favor.
