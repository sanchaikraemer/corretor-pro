...
// v1198 — O CAMPO "Período padrão dos áudios" SAIU DA TELA DO CÉREBRO, MAS A PROTEÇÃO FICOU.
//
...
// Quem tinha um valor próprio (ex.: 180) salvo antes da v1198 continua com ele: o save preserva
...
console.log("v1198-periodo-audios-sem-campo-na-tela: ok");
