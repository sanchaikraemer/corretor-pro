...
// v1370 — quando há uma lacuna prioritária, a suave muda a ABORDAGEM, não o dado a descobrir.
// Continua proibido devolver a recomendada reescrita, mas também ficou proibido pular para uma
// lacuna secundária só para as três parecerem diferentes.
assert.match(pipeline, /"maisSuave":"segunda abordagem para o MESMO objetivo comercial prioritário/, 'a suave precisa mudar a abordagem sem abandonar o objetivo prioritário');
assert.match(pipeline, /MESMA LACUNA NÃO SIGNIFICA MESMA MENSAGEM/, 'mesmo objetivo não libera três cópias');
