// v1118 — o preço da assinatura (Pro R$ 67, Pro Master R$ 97) passa a aparecer no convite quando
// o corretor bate no limite (api/_pipeline.js) e na tela de "teste acabou" (entrar.html), com botão
// pro WhatsApp comercial. Preço definido no servidor com override por env; a tela de login usa os
// mesmos valores. Teste estático (lê o texto-fonte) — protege contra sumiço do preço/botão.
...
assert.match(pipeline, /const PRECOS_PLANOS = \{ "pro": 67, "pro-master": 97 \}/, "preços Pro/Pro Master definidos");
...
assert.match(entrar, /R\$ 67\/mês/, "tela de teste acabado precisa mostrar o preço do Pro");
assert.match(entrar, /R\$ 97\/mês/, "tela de teste acabado precisa mostrar o preço do Pro Master");
