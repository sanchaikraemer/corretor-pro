# v1212 — compromisso atendido no dia marcado deixa de ser cobrado como atrasado
...
- `tests/v1212-atendido-na-data-nao-e-atrasado.test.mjs` — guarda de regressão que executa a régua de
  ...
  correção.
- `package.json` / `package-lock.json` — versão 1212.
