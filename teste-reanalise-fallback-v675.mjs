...
assert.match(app,/if\(!analysis\|\|schema<678\)/);
...
assert.match(leadUpdate,/schemaComercial: 676/);
assert.match(reanalisar,/apiVersion: 676/);
assert.match(pipeline,/parsed\._schemaComercial = 676/);
assert.match(pipeline,/out\._schemaComercial = 676/);
console.log('teste-reanalise-fallback-v676: OK');
