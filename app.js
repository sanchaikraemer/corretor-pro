...
// ===== Atualização #722: instrumentação leve de performance =====
...
// ===== Histórico interno do app (Atualização #722) =====
...
// Atualização #722: a seta física fecha a gaveta antes de sair da tela atual.
...
const ARQUITETURA_MENSAGENS_ATUAL = "gpt55-v722-chatgpt-puro-sem-lixo";
...
/* ============================================================
   Atualização #722 — Tela do lead consolidada
...
// Atualização #722: card "O que mudou" — antes → agora + por que importa.
...
// Atualização #722: o cabeçalho e os indicadores pertencem à tela Hoje, não ao detalhe do lead.
...
// Atualização #722: wrapper antigo de renderLeadFoco removido.
...
/* ============================================================
   Atualização #722 — revisão de auditoria
...
/* ============================================================
   Atualização #722 — fechamento real da pendência de performance
...
/* ============================================================
   Atualização #722 — acabamento profissional estável
   ============================================================ */
(function(){
...
/* ============================================================
   Atualização #722 — Hotfix real mobile
...
(function(){
  ...
  function cp694FixVersion(){
    document.querySelectorAll('.sb-brand small,.cp-brand small,.brand small,[data-version]').forEach(el=>{
      ...
      if(/Atualiza[cç][aã]o\s*#/i.test(txt)) el.textContent = txt.replace(/Atualiza[cç][aã]o\s*#\d+(?:-\d+)?/i,'Atualização #722');
    });
  }
...
/* ============================================================
   Atualização #722 — Correção real da lista mobile
...
/* ============================================================
   Atualização #722 — Correção definitiva carregamento total Atendimentos
...
/* ============================================================
   Atualização #722 — Preparação da Carteira
...
/* ============================================================
   Atualização #722 — correção de versão exibida no topo/mobile
...
(function(){
  ...
  function fixVersionText(){
    try{
      ...
      nodes.forEach(n=>{
        n.nodeValue = String(n.nodeValue || '').replace(/Atualiza[cç][aã]o\s*#\d+(?:-\d+)?/ig, 'Atualização #722');
      });
...
/* ============================================================
   Atualização #722 — estabilidade pós-cache
...
/* ============================================================
   Atualização #722 — Preparação da Carteira estável
...
// Atualização #722: bloco antigo da tela orientada à ação removido; renderLeadFoco foi consolidado na função principal.
