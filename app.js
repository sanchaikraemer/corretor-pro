...
// ===== Atualização #721: instrumentação leve de performance =====
...
// ===== Histórico interno do app (Atualização #721) =====
...
// Atualização #721: a seta física fecha a gaveta antes de sair da tela atual.
...
const ARQUITETURA_MENSAGENS_ATUAL = "gpt55-v721-analise-pura-chatgpt";
...
/* ============================================================
   Atualização #721 — Tela do lead consolidada
...
// Atualização #721: card "O que mudou" — antes → agora + por que importa.
...
// Atualização #721: o cabeçalho e os indicadores pertencem à tela Hoje, não ao detalhe do lead.
...
// Atualização #721: wrapper antigo de renderLeadFoco removido.
...
/* ============================================================
   Atualização #721 — revisão de auditoria
...
/* ============================================================
   Atualização #721 — fechamento real da pendência de performance
...
/* ============================================================
   Atualização #721 — acabamento profissional estável
   ============================================================ */
(function(){
...
/* ============================================================
   Atualização #721 — Hotfix real mobile
...
(function(){
  ...
  function cp694FixVersion(){
    document.querySelectorAll('.sb-brand small,.cp-brand small,.brand small,[data-version]').forEach(el=>{
      ...
      if(/Atualiza[cç][aã]o\s*#/i.test(txt)) el.textContent = txt.replace(/Atualiza[cç][aã]o\s*#\d+(?:-\d+)?/i,'Atualização #721');
    });
  }
...
/* ============================================================
   Atualização #721 — Correção real da lista mobile
...
/* ============================================================
   Atualização #721 — Correção definitiva carregamento total Atendimentos
...
/* ============================================================
   Atualização #721 — Preparação da Carteira
...
/* ============================================================
   Atualização #721 — correção de versão exibida no topo/mobile
...
(function(){
  ...
  function fixVersionText(){
    try{
      ...
      nodes.forEach(n=>{
        n.nodeValue = String(n.nodeValue || '').replace(/Atualiza[cç][aã]o\s*#\d+(?:-\d+)?/ig, 'Atualização #721');
      });
...
/* ============================================================
   Atualização #721 — estabilidade pós-cache
...
/* ============================================================
   Atualização #721 — Preparação da Carteira estável
...
// Atualização #721: bloco antigo da tela orientada à ação removido; renderLeadFoco foi consolidado na função principal.
