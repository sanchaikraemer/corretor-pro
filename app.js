...
function renderBotoesHome(){
  ...
  foco.innerHTML = `
    <style>
      ...
      .cp-hoje-row .chr-exp{grid-area:exp;font-size:11.5px;font-weight:800;color:var(--cyan);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
