# v1324 — a trava que não depende de ninguém lembrar

Terceiro bloco da auditoria de 20/08/2026. As duas primeiras versões (v1322 e v1323) resolveram o
...
- Guardas novas: `tests/v1324-isolamento-entre-empresas-na-guarda.test.mjs` (91 consultas
  conferidas, 2 exceções declaradas), `tests/v1324-configuracao-catalogada.test.mjs` (catálogo
  completo, conferência pegando cada tipo de erro, nenhum segredo vazando na resposta) e
  `tests/v1324-publicacao-nao-sobe-com-teste-vermelho.test.mjs`.
...
- Chromium (390px e 1280px): o cartão novo do painel, no tema escuro. A 390px os nomes longos de
  ...
  reconferido.
- `npm test`: 31 arquivos checados + 471 testes, verdes.
