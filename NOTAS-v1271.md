# v1271 — o iPhone ganha o passo a passo dele (e some a ideia de que precisa de computador)
...
- Suíte completa verde (23 arquivos + 426 testes).
- Teste de regressão novo: `tests/v1271-passo-a-passo-do-iphone.test.mjs` — guarda os seis passos do
